// static/js/dashboard.js - VERSION CORRIGÉE (THÈMES POPULAIRES)
...
class DashboardManager {
    ...
    static async createTimelineChart(timelineData) {
        ...
        const allData = [...positiveData, ...negativeData, ...neutralData];
    ...
    static loadPopularThemes(themeStats) {
        ...
        // Trier les thèmes par nombre d'articles (décroissant)
        const sortedThemes = Object.entries(themeStats)
            ...
            .sort((a, b) => b[1].article_count - a[1].article_count)
            .slice(0, 8); // Limiter à 8 thèmes maximum
        ...
        // Générer le HTML pour chaque thème
