...
def create_social_tables(db_manager):
    """Crée les tables pour les réseaux sociaux"""
    conn = db_manager.get_connection()
    cursor = conn.cursor()
    
    try:
        # Table pour les posts sociaux
        cursor.execute("""
        ...
        # Table pour les comparaisons de sentiment
        cursor.execute("""
        ...
        # Table pour les analyses historiques
        cursor.execute("""
        ...
        conn.commit()
        logger.info("✅ Tables sociales et historiques créées")
