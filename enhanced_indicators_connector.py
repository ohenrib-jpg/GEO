# Flask/enhanced_indicators_connector.py
"""
...
class EnhancedIndicatorsConnector:
    ...
    def _get_eurostat_indicators(self) -> Dict[str, EconomicIndicator]:
        ...
        # ✅ Indicateurs par défaut (sans unemployment, remplacé par GINI)
        default_ids = ['gdp', 'hicp', 'trade_balance']
        ...
        try:
            ...
            if insee_data.get('success'):
                for key, data in insee_data['indicators'].items():
                    ...
                    reliability = 'scraped' if insee_data['source'] == 'INSEE scraping' else 'fallback'
                    ...
                    indicators[f'insee_{key}'] = self._create_indicator(
                        ...
                        unit=data['unit'],
                        period=data['period'],
                        change_percent=0.0,  # Non disponible via scraping
